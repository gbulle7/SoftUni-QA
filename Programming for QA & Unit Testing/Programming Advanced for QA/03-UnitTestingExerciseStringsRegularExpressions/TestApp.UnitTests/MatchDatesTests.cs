...
public class MatchDatesTests
{
    ...
    public void Test_Match_ValidDate_ReturnsExpectedResult()
    {
        ...
        // Act
        string result = MatchDates.Match("31/Dec/2022");
    ...
    {
        // Arrange
        string expected = "Day: 11, Month: July, Year: 1990";

        // Act
        string result = MatchDates.Match("11-July-1990, 01-Jul-1992");
    ...
    public void Test_Match_EmptyString_ReturnsEmptyString()
    {
        ...
        // Act
        string result = MatchDates.Match("");
